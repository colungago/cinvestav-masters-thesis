...
El electroencefalograma (EEG) es una técnica no invasiva que mide la actividad eléctrica del cerebro a través de electrodos colocados en el cuero cabelludo. Esta técnica es utilizada en la clínica para el diagnóstico de enfermedades neurológicas como epilepsia, trastornos del sueño, y lesiones cerebrales, así como en la investigación de la actividad cerebral en tareas cognitivas y emocionales \cite{Niedermeyer2005}. El EEG es una herramienta de gran utilidad en la neurociencia, ya que permite estudiar la actividad cerebral en tiempo real y con alta resolución temporal, lo que lo hace ideal para estudiar la dinámica de la actividad cerebral en tareas cognitivas y emocionales \cite{Luck2014}.
