...
\begin{itemize}
	...
	\item \TODO{Estandarizar los títulos.}
	\item \TODO{Preguntar} Dentro del texto debo escrbir los números usando el modo matemático? Por ejemplo, debo escribir ``0.5'' o ``$0.5$''?
\end{itemize}
